...
- Check at minimum: the winning cut, scope and non-goals, explicit `Gap Analysis Requirement`, target-state structure, `5.4` boundary allocation, and the correctness surface.
