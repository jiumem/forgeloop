...
- `full_doc_default`
  - authoritative full-document Milestone packets remain the default runtime route
...
- This loop specifies only the Milestone-specific proofs that must still be established after that shared read path.
