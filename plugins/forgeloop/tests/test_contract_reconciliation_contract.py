...
class ContractReconciliationContractTests(unittest.TestCase):
    ...
    def test_prompt_contract_rejects_a_shadow_workflow_engine(self) -> None:
        paths = (
            ...
            PLUGIN_ROOT / "config/overlays/to-spec-append.md",
            PLUGIN_ROOT / "config/overlays/domain-modeling-append.md",
            PLUGIN_ROOT / "config/overlays/to-tickets-append.md",
        )
    ...
    def test_only_key_runtime_fixture_is_added(self) -> None:
        fixture = json.loads(
            (PLUGIN_ROOT / "fixtures/m2-runtime-matrix.json").read_text(encoding="utf-8")
        )
        cases = [
