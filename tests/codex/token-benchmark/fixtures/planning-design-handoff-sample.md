# Design Rolling Doc: SAMPLE-HANDOFF
...
handoff_id: design-r2-a1
review_target_ref: docs/initiatives/active/anchor-sliced-dispatch-optimization/design.md#design-v2
```
