---
name: using-forgeloop
description: Use when starting any conversation - establishes Codex skill discipline and requires loading relevant skills before any response, question, or action
---
...
digraph skill_flow {
    ...
    "Create update_plan checklist" [shape=box];
    ...
    "Has checklist?" -> "Create update_plan checklist" [label="yes"];
    "Has checklist?" -> "Follow skill exactly" [label="no"];
    "Create update_plan checklist" -> "Follow skill exactly";
}
```
