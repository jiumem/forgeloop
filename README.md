...
> 当前版本：`3.2.0` · 20 个正式 Skill · 11 个用户入口 · 9 个模型可调用能力

[完整中文手册](README.zh-CN.md) · [3.2 发布说明](docs/releases/3.2.0-release-notes.md) · [迁移指南](docs/migrations/2.5.0-to-3.0.0.md)
