...
`0.2.0` does not require a Python package install step. Clone the repository, install the skills link, and then materialize the suite's agent manifests into each target Codex project.
